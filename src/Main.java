...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Shape of You",5.0);
        albums.add(album);

        album = new Album("Album2","Maroon5");

        album.addSong("Memories",4.5);
        album.addSong("She will be loved",3.5);
        ...
        albums.get(0).addToPlayList("STAY",playList_1);
        albums.get(0).addToPlayList("Peaches",playList_1);
        albums.get(1).addToPlayList("Memories",playList_1);
        albums.get(1).addToPlayList("Girls like You ",playList_1);
